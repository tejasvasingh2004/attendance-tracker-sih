...
/**
 * POST /attendance/session/:sessionId/proxy-check
 * Analyze session attendance for proxy patterns
 * 
 * Parameters:
 *   sessionId: string - Session ID
 * 
 ...
 * }
 */
router.post('/session/:sessionId/proxy-check', detectProxyAttendance);
